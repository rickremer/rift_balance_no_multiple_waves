return function()
	...
	{
		{ name = "cobalt_vein", runOutPercentageOnMap = 10, minToSpawn = 8000, maxToSpawn = 15000 },
	}

	rules.majorAttackLogic =
	{			
		{ level = 2 , prepareTime = 300, entryLogic = "logic/dom/major_attack_1_entry.logic", exitLogic = "logic/dom/major_attack_1_exit.logic" },
	}
