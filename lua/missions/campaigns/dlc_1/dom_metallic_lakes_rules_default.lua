return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_thunderstorm",  type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/thunderstorm.logic", minTime = 60, maxTime = 120 },
		...
		{ action = "spawn_fog",           type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/fog.logic", minTime = 60, maxTime = 120, weight = 1  },
		...
		{ action = "spawn_wind_none",     type = "NEGATIVE", gameStates="ATTACK|IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/wind_none.logic", minTime = 180, maxTime = 240, weight = 3 },
