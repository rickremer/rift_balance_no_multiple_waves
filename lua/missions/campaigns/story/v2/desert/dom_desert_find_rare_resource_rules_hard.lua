return function()
    local rules = require("lua/missions/campaigns/story/v2/desert/dom_desert_find_rare_resource_rules_default.lua")()
	...
	rules.waves = {}
	rules.waves = helper:Default_Waves("desert", "scout", "hard", rules.waves)

	rules.waves = helper:Generate({ groups = { "caverns" },   difficulty = {                9}, biomes = { "group" },   levels = { 1, 2 },  suffixes = { "", "", "alpha" }, },   rules.waves)
	rules.waves = helper:Generate({ groups = { "caverns" },   difficulty = {                9}, biomes = { "group" },   levels = { 2, 3 },  suffixes = { "", "" },          },   rules.waves)
