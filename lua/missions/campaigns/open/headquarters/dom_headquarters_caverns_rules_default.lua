...
return function(params)
	...
	rules.addResourcesOnRunOut = {
		{ name = "carbon_vein",   runOutPercentageOnMap = 25, minToSpawn = 50000, maxToSpawn = 80000,              events = { "spawn_resource_earthquake" }},
		{ name = "iron_vein",     runOutPercentageOnMap = 25, minToSpawn = 50000, maxToSpawn = 80000,              events = { "spawn_resource_earthquake" }},
		{ name = "cobalt_vein",   runOutPercentageOnMap = 20, minToSpawn = 10000, maxToSpawn = 20000,              events = { "spawn_resource_earthquake" }},
