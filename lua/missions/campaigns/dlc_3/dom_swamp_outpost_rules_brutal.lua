return function()
	...
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {          4, 5, 6, 7, 8 ,9}, biomes = { "jungle" }, levels = { 2 },   ids = { 1, 2 },   suffixes = { "ultra" },         },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {          4, 5, 6, 7, 8, 9}, biomes = { "jungle" }, levels = { 3 },   ids = { 1, 2 },   suffixes = { "" },              },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {             5, 6, 7, 8, 9}, biomes = { "jungle" }, levels = { 3 },   ids = { 1, 2 },   suffixes = { "", "alpha" },     },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {                6, 7, 8, 9}, biomes = { "jungle" }, levels = { 3 },   ids = { 1, 2 },   suffixes = { "ultra" },         },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {                6, 7, 8, 9}, biomes = { "jungle" }, levels = { 4 },   ids = { 1, 2 },   suffixes = { "" },              },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {                   7, 8, 9}, biomes = { "jungle" }, levels = { 4 },   ids = { 1, 2 },   suffixes = { "", "alpha" },     },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {                      8, 9}, biomes = { "jungle" }, levels = { 4 },   ids = { 1, 2 },   suffixes = { "ultra" },         },   rules.waves)
	rules.waves = wave_gen:Generate({ groups = { "metallic" },  difficulty = {                         9}, biomes = { "jungle" }, levels = { 5 },   ids = { 1, 2 },   suffixes = { "", "alpha" },     },   rules.waves)
